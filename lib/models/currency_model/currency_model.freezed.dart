...
mixin _$CurrencyModel {
  ...
  List<CurrencyItemModel> get items => throw _privateConstructorUsedError;
...
abstract class $CurrencyModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String guid, String caption, List<CurrencyItemModel> items});
}
...
class _$_CurrencyModel implements _CurrencyModel {
  _$_CurrencyModel(
      {required this.guid, required this.caption, required this.items});
  ...
  @override
  final List<CurrencyItemModel> items;

  @override
  String toString() {
    return 'CurrencyModel(guid: $guid, caption: $caption, items: $items)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, guid, caption, const DeepCollectionEquality().hash(items));
...
abstract class _CurrencyModel implements CurrencyModel {
  factory _CurrencyModel(
      ...
      required final List<CurrencyItemModel> items}) = _$_CurrencyModel;
  ...
  String get caption;
  @override
  List<CurrencyItemModel> get items;
  @override
  @JsonKey(ignore: true)
  _$$_CurrencyModelCopyWith<_$_CurrencyModel> get copyWith =>
      throw _privateConstructorUsedError;
