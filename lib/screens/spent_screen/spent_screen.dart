...
import 'package:pcassa_retail/screens/spent_screen/spent_create_widget/spent_create_widget.dart';
import 'package:pcassa_retail/screens/spent_screen/spent_edit_widget/spent_edit_widget.dart';
      ...
      child: Scaffold(
        ...
        body: Observer(
          builder: (_) =>
            ...
            for (var i = 0; i < spentState.spentList.length; i++)
              Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: BigText(
                              text: spentState.spentList[i].name,
                              color: AppColors.appWhite,
                            ),
                          ),
