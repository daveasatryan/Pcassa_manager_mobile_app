  ...
  void initState() {
    groupList = [
      ...
      for (int i = 0; i < getProducts.productsCategoryList.length; i++)
        DropdownMenuItem(
            value: "${getProducts.productsCategoryList[i].guid}",
            child: MiddleText(
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    switch (
                                                                      ...
                                                                      case '9d160d60-4c16-4ff7-b9f4-459c93313d14':
                                                                        {
                                                                          try {
                                                                            await getProducts.changeGroupe(
