...
class CreateContragent extends StatefulWidget {
  ...
  final parentGuid;
  @override
  State<CreateContragent> createState() => _CreateContragentState();
}
...
class _CreateContragentState extends State<CreateContragent> {
  @override
  void initState() {
    super.initState();
                ...
                case '9d160d60-4c16-4ff7-b9f4-459c93313d14':
                  {
                    try {
                      ...
                      // await getContragent.categoryFirstMade();
                    } catch (e) {
                      if (e is DioError) {
