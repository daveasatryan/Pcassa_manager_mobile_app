...
class ContragentElementEdit extends StatefulWidget {
  const ContragentElementEdit({
    Key? key,
  ...
  final ContragentItemsModel element;
  final isRoot;
  final mainCategoryGuid;
  @override
  State<ContragentElementEdit> createState() => _ContragentElementEditState();
}

class _ContragentElementEditState extends State<ContragentElementEdit> {
  ...
  @override
  void initState() {
    contragentCodContraller.text = widget.element.kod!;
    nameContraller.text = widget.element.name.toString().replaceAll("null", '');

    fullNameContraller.text =
        widget.element.full_name.toString().replaceAll("null", '');

    yourAdressContraller.text =
        widget.element.yur_adres.toString().replaceAll("null", '');

    postAdressContraller.text =
        widget.element.post_adres.toString().replaceAll("null", '');

    telephoneContraller.text =
        widget.element.tel.toString().replaceAll("null", '');

    contactNameConttraller.text =
        widget.element.contact_litso.toString().replaceAll("null", '');

    innContraller.text = widget.element.inn.toString().replaceAll("null", '');

    kppContraller.text = widget.element.kpp.toString().replaceAll("null", '');

    rrshetContraller.text =
        widget.element.rshet.toString().replaceAll("null", '');

    kshetContraller.text =
        widget.element.kshet.toString().replaceAll("null", '');

    bikContraller.text = widget.element.bik.toString().replaceAll("null", '');

    bankNameContraller.text =
        widget.element.bank_name.toString().replaceAll("null", '');

    credditContraller.text =
        widget.element.kredit.toString().replaceAll("null", '');

    primContraller.text = widget.element.prim.toString().replaceAll("null", '');
