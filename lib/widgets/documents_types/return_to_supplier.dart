...
class ReturnToSupplier extends StatefulWidget {
  const ReturnToSupplier({Key? key, required this.documentType})
      : super(key: key);
  final String documentType;
  @override
  State<ReturnToSupplier> createState() => _ReturnToSupplierState();
}
...
class _ReturnToSupplierState extends State<ReturnToSupplier> {
  //Contrallers
  ...
  void initState() {
    ...
    firstWarehouseContraller = naklInfoState.naklInfoItems!.skl2name;
