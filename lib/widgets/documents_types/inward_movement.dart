...
class InvardMovment extends StatefulWidget {
  const InvardMovment({Key? key, required this.documentType}) : super(key: key);
  final String documentType;
  @override
  State<InvardMovment> createState() => _InvardMovmentState();
}
...
class _InvardMovmentState extends State<InvardMovment> {
  //Contrallers
  ...
  String? secondWarehouseContraller;
  int? idContraller;
  int? statusCheck;
  bool? statusChecked;
  bool isLoading = true;
  ...
  int? contragentCode;
  int? firstWarehouseCode;
  int? secondWarehouseCode;
  ...
  void initState() {
    ...
    firstWarehouseCode = naklInfoState.naklInfoItems!.skl1;
    secondWarehouseCode = naklInfoState.naklInfoItems!.skl2;
    firstWarehouseContraller = naklInfoState.naklInfoItems!.skl1name;
    secondWarehouseContraller = naklInfoState.naklInfoItems!.skl2name;
                      ...
                      child: ListTile(
                        ...
                        subtitle: DropdownButton2(
                            ...
                            items: warehouseState.warehouseNames
                                ...
                                .toList(),
                            value: !warehouseState.warehouseNames
                                    .contains(secondWarehouseContraller)
                                ? "notSelected"
                                : secondWarehouseContraller,
                            onChanged: (value) {
                              setState(() {
                                secondWarehouseContraller = value!;
                              });
                              for (int i = 0;
                                  i < warehouseState.warehouseList.length;
                                  i++) {
  ...
  saveDocument() async {
    await naklInfoState.createDocument(
      ...
      naklinfo_items_model: NaklInfoItemsModel(
          ...
          skl1: firstWarehouseCode,
          skl2: secondWarehouseCode,
          skl1name: firstWarehouseContraller,
          skl2name: secondWarehouseContraller,
          srok_oplati: "",
