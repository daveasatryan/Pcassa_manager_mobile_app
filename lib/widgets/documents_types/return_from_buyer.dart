...
class ReturnFromBuyer extends StatefulWidget {
  const ReturnFromBuyer({Key? key, required this.documentType})
      : super(key: key);
  final String documentType;
  @override
  State<ReturnFromBuyer> createState() => _ReturnFromBuyerState();
}
...
class _ReturnFromBuyerState extends State<ReturnFromBuyer> {
  //Contrallers
